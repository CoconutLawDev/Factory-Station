...
health-analyzer-window-entity-unrevivable-text = [color=yellow]Обнаружен уникальный состав тела! Пациент не подлежит реанимации обычными средствами![/color]
...
health-analyzer-popup-scan-target = {CAPITALIZE($user)} пытается отсканировать вас!
