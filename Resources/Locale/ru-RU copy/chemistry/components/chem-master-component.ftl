...
chem-master-window-discard-button = Выбросить
chem-master-window-packaging-text = Упаковка
chem-master-current-text-label = Название:
...
chem-master-window-sort-type-none = Сортировать: Сначала старые
...
chem-master-window-sort-type-latest = Сортировать: Сначала новые
