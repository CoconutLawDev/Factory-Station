guidebook-reagent-effect-description =
    {$quantity ->
        [0] {""}
        *[other] Если есть хотя бы {$quantity} ед {$reagent},{" "}
    }{$chance ->
        [1] { $effect }
...
guidebook-reagent-plant-metabolisms-rate = [bold]Метаболизм растений[/bold] [color=gray](1 ед каждые 3 секунды как основа)[/color]
