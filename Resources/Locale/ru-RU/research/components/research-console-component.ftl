...
research-console-menu-research-points-text = Очков исследований: [color=orchid]{$points}[/color]
...
research-console-unlock-technology-radio-broadcast = [bold]{$approver}[/bold] разблокировал [bold]{$technology}[/bold] за [bold]{$amount}[/bold] очков исследований.
