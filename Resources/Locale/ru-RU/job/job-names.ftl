...
job-name-centcommoff = Офицер Центкома
...
job-name-ertleader = Командующий ОБР
...
job-name-qm = Бригадир снабжения
job-name-rd = Бригадир Производства
job-name-reporter = Репортёр
job-name-research-assistant = Ассистент Оператора производства
job-name-salvagespec = Утилизатор
job-name-scientist = Оператор производства
...
JobQuartermaster = Бригадир снабжения
JobReporter = Репортёр
JobResearchAssistant = Ассистент Оператора производства
JobResearchDirector = Бригадир производства
JobSalvageSpecialist = Утилизатор
JobScientist = Оператор производства
