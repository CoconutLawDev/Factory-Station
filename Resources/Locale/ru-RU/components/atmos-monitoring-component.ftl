atmos-monitoring-window-title = Монитор атмосферных сетей
...
atmos-monitoring-window-label-gas-scrubber = Скруббер воздуха
...
atmos-monitoring-window-toggle-overlays = Переключить наложение карты
atmos-monitoring-window-show-pipe-network = Сеть трубопровода
