...
reagent-grinder-bound-user-interface-cook-time-label = ВРЕМЯ ПРИГОТОВЛЕНИЯ
reagent-grinder-component-cannot-put-entity-message = Вы не можете поместить это в измельчитель реагентов!

grinder-menu-title = Всё-в-одном измельчитель 3000
grinder-menu-grind-button = Измельчить
grinder-menu-juice-button = Выжать сок
