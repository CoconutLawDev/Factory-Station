wires-panel-component-on-examine-open = [color=lightgray]Панель техобслуживания[/color] [color=red]открыта[/color].
wires-panel-component-on-examine-closed = [color=lightgray]Панель техобслуживания[/color] [color=darkgreen]закрыта[/color].

wires-panel-verb-view-panel = Открыть панель техобслуживания
