...
id-card-component-microwave-burnt = Схемы {$id} громко щёлкают!
id-card-component-microwave-bricked = Схемы {$id} шипят!
id-card-component-microwave-safe = Схемы {$id} издают странный шум.
