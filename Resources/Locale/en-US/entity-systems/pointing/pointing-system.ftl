...
pointing-system-point-at-other-others = {CAPITALIZE($otherName)} указывает на {THE($other)}.
...
pointing-system-point-in-other-inventory-others = {CAPITALIZE($pointer)} указывает на {$item} {THE($wearer)}.
