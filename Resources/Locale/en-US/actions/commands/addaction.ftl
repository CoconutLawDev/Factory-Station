# addaction
cmd-addaction-desc = Добавляет действие целевой сущности. Действие не будет работать, если цели требуется дополнительный компонент на её сущности (например, Пожирание Дракона).
...
cmd-addaction-action-not-found = Не удаётся найти подходящий прототип действия {$action}.
